...
export default function Cards({index}) {
  return (
    <motion.div initial={{opacity:0,scale:0.7}} animate={{y:30,opacity:1,scale:1}} transition={{delay:index * 0.2, ease:'easeIn', duration:0.3}} className="border-1 border-gray-400 bg-gray-100 flex flex-col justify-center items-center text-center px-2 py-3 max-md:w-[100%]">
            <div className='    '>
